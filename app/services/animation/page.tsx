...
export default function animation() {
  ...
  const banner_text = "Bring ideas to life through motion and storytelling."
  const service_type = "Where Creativity Moves"
  const service_para = "At InkspireFolio, we specialize in crafting dynamic animations that transform concepts into compelling visual stories. From explainer videos and product showcases to creative campaigns, our animations simplify complex ideas while keeping your audience engaged. With an eye for detail and a passion for innovation, we design animations that spark curiosity and leave a memorable impression."
  const Portfolio_heading = "Animation Showcase"
  const Portfolio_para = "Every frame is designed with precision and creativity — ensuring your story resonates, inspires, and connects with viewers."
